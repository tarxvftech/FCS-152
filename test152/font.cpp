...
const unsigned char pic_0408[][4]= {
    {0x00,0x18,0x1C,0x18},      //Icon "Arrow on" (?) - I am not sure about the correctness of the translation!
    {0x00,0x0C,0x1C,0x0C},      //Icon "Under the arrow" (?) - I am not sure about the correctness of the translation!
    {0x00,0x1C,0x1C,0x1C},      //Icon "Volume" (?) - I am not sure about the correctness of the translation!
};
//
//
const unsigned char ascii_0608[][6]= { //Each character is represented by 6 data
    ...
    {0x00,0x7C,0xA2,0x92,0x8A,0x7C},//'0'   16 original ASCII：48-》48-0x20=16
    ...
    {0x00,0x00,0x00,0xD8,0xD8,0x00},//':' colon
...
const char pic_0608[][6]= {
    {0x00,0x10,0x38,0x7C,0xFE,0x00},    //Left arrow
    {0x00,0xFE,0x7C,0x38,0x10,0x00},    //Right arrow
    {0x0c,0x06,0x03,0x0c,0x30,0xc0},    //Tick
    {0x00,0x40,0x60,0x70,0x60,0x40},    //Up arrow
    {0x00,0x02,0x06,0x0E,0x06,0x02},    //Down arrow
    {0x00,0x00,0x00,0x00,0x00,0x00},    //' '
};
//
//
const char pic_0808[][8]= {
    {0x00,0x74,0x32,0x52,0x4A,0x4C,0x2E,0x00},      //Cycle sign
    {0x18,0x38,0x70,0x70,0x38,0x1c,0x0e,0x06},      //Tick
};

//

//10 columns and 16 rows
const unsigned char ascii_1016[][20]= {
    ...
    {0x00,0xFC,0xFE,0x06,0x06,0x86,0x86,0xFE,0xFE,0xFC,0x00,0x7F,0xFF,0xFE,0xC3,0xC3,0xC1,0xC0,0xFF,0x7F},//'0'     //16 original ASCII：48-》48-0x20=16
    ...
    {0x00,0x00,0x80,0xC0,0xE0,0xF0,0xF8,0xFC,0xFE,0x00,0x00,0x01,0x03,0x07,0x0F,0x1F,0x3F,0x7F,0xFF,0x00},//Left arrow
    {0x00,0xFE,0xFC,0xF8,0xF0,0xE0,0xC0,0x80,0x00,0x00,0x00,0xFF,0x7F,0x3F,0x1F,0x0F,0x07,0x03,0x01,0x00},//Right arrow
};
...
const char pic_1616[]= {
    ...
    0x00,0x00,0x03,0x24,0x20,0x31,0x30,0x3F,0x3F,0x30,0x31,0x20,0x24,0x03,0x00,0x00,//1. Signal flag (not selected)

    0xFF,0x01,0xF9,0x05,0xE1,0x11,0x01,0xC1,0xC1,0x01,0x11,0xE1,0x05,0xF9,0x01,0xFF,
    0xFF,0x80,0x83,0xA4,0xA0,0xB1,0xB0,0xBF,0xBF,0xB0,0xB1,0xA0,0xA4,0x83,0x80,0xFF,//2. Signal flag (selected)

    0x00,0x00,0x7C,0x14,0x00,0x7C,0x18,0x7C,0x80,0x40,0x20,0x10,0x08,0x04,0x00,0x00,
    0x00,0x00,0x20,0x10,0x08,0x04,0x1E,0x21,0x1C,0x00,0x3C,0x20,0x3C,0x00,0x00,0x00,//3. A/B mode (not selected)

    0xFF,0x01,0x7D,0x15,0x01,0x7D,0x19,0x7D,0x81,0x41,0x21,0x11,0x09,0x05,0x01,0xFF,
    0xFF,0x80,0xA0,0x90,0x88,0x84,0x9E,0xA1,0x9C,0x80,0xBC,0xA0,0xBC,0x80,0x80,0xFF,//4. A/B mode (selected)

    0x00,0x00,0x00,0x00,0x00,0x00,0xF0,0x08,0x04,0x04,0x04,0x04,0x08,0xF0,0x00,0x00,
    0x00,0x00,0x30,0x38,0x1C,0x0E,0x07,0x03,0x02,0x02,0x02,0x02,0x01,0x00,0x00,0x00,//5. Search mode (not selected)

    0xFF,0x01,0x01,0x01,0x01,0x01,0xF1,0x09,0x05,0x05,0x05,0x05,0x09,0xF1,0x01,0xFF,
    0xFF,0x80,0xB0,0xB8,0x9C,0x8E,0x87,0x83,0x82,0x82,0x82,0x82,0x81,0x80,0x80,0xFF,//6. Search mode (selected)

    0x00,0x00,0x70,0x38,0x3C,0x7C,0xE4,0xC0,0x80,0xD8,0x24,0x40,0x40,0x20,0x00,0x00,
    0x00,0x00,0x04,0x02,0x02,0x24,0x1A,0x01,0x03,0x07,0x0E,0x1C,0x38,0x30,0x00,0x00,//7. Settings (not selected)

    0xFF,0x01,0x71,0x39,0x3D,0x7D,0xE5,0xC1,0x81,0xD9,0x25,0x41,0x41,0x21,0x01,0xFF,
    0xFF,0x80,0x84,0x82,0x82,0xA4,0x9A,0x81,0x83,0x87,0x8E,0x9C,0xB8,0xB0,0x80,0xFF,//8. Settings (selected)

    0x00,0x00,0x00,0x00,0x00,0x00,0x80,0x78,0x04,0x04,0x04,0x04,0x04,0x78,0x80,0x00,
    0x00,0x00,0x00,0x00,0x00,0xFF,0xC1,0xC1,0xC1,0xC1,0xC1,0xC1,0xC1,0xC1,0xC1,0xFF,//9. Locked

    0x00,0x18,0x0C,0x04,0x04,0x04,0x8C,0x78,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    0x00,0x00,0x00,0x00,0x00,0xFF,0xC1,0xC1,0xC1,0xC1,0xC1,0xC1,0xC1,0xC1,0xC1,0xFF,//10. Unlock

    0x00,0xFC,0x02,0x02,0x82,0xC2,0xE2,0xF2,0x02,0x02,0x82,0xC2,0xE2,0xF2,0x02,0xFC,
    0x00,0x7F,0x80,0x81,0x83,0x87,0x8F,0x9F,0x80,0x81,0x83,0x87,0x8F,0x9F,0x80,0x7F,//11. Search forward

    0x00,0xFC,0x02,0xF2,0xE2,0xC2,0x82,0x02,0x02,0xF2,0xE2,0xC2,0x82,0x02,0x02,0xFC,
    0x00,0x7F,0x80,0x9F,0x8F,0x87,0x83,0x81,0x80,0x9F,0x8F,0x87,0x83,0x81,0x80,0x7F,//12. Search backward

    0x00,0xFC,0x02,0x02,0x02,0x82,0x42,0x42,0x42,0x42,0x4A,0x52,0xE2,0x42,0x02,0xFC,
    0x00,0x7F,0x80,0x80,0xBF,0x80,0x80,0x80,0x80,0x80,0x82,0x81,0x80,0x80,0x80,0x7F,//13. Return flag

    0x00,0x80,0x80,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xC0,0xE0,0xF0,0xFC,0x3E,0x0E,
    0x00,0x03,0x07,0x0F,0x1E,0x3C,0x78,0x78,0x7C,0x3F,0x0F,0x07,0x03,0x00,0x00,0x00,//14. Hook (?)
...
const unsigned char pic_XVF[] = {
    
};
