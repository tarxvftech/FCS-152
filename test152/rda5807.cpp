...
{	
	if(off_on)
	{
		RDA_Power(ON);delay_ms(2);
		RDA5807_WriteReg(RDA5807_R02,0xc001);delay_ms(700);
		RDA5807_WriteReg(RDA5807_R04,0x0400);delay_ms(60);
		RDA5807_WriteReg(RDA5807_R05,0xc5Ac);delay_ms(60);
		RDA5807_WriteReg(RDA5807_R02,0xf281);delay_ms(70);//delay_ms(700);
	...
	else
	{
		...
		RDA5807_WriteReg(RDA5807_R02,0x0000);delay_ms(50);//printf("Close FM: %d\n", WFM);
		RDA_Power(OFF);
	}
...
void RDA5807_MUTE()
{
	RDA5807_WriteReg(RDA5807_R02, 0x0000);delay_ms(50);
}
void RDA5807_NMUTE()
{
	RDA5807_WriteReg(RDA5807_R02, 0xc001);delay_ms(500);//唤醒
}
//
