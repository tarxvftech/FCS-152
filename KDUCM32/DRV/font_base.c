...
const unsigned char ascii_0608[][6]=        //Each character is represented by 6 data
{
    ...
    {0x00,0x7C,0xA2,0x92,0x8A,0x7C},//'0'	16 Raw ASCII：48-》48-0x20=16
...
{0x00,0xFC,0xFE,0x06,0x06,0x86,0x86,0xFE,0xFE,0xFC,0x00,0x7F,0xFF,0xFE,0xC3,0xC3,0xC1,0xC0,0xFF,0x7F},//'0'     //16 Raw ASCII：48-》48-0x20=16
...
{
    {0x00,0x18,0x1C,0x18},      //Arrow on
    {0x00,0x0C,0x1C,0x0C},      //Under the arrow
    {0x00,0x1C,0x1C,0x1C},      //Volume
};
//
...
0x00,0x03,0x07,0x0F,0x1E,0x3C,0x78,0x78,0x7C,0x3F,0x0F,0x07,0x03,0x00,0x00,0x00,//14.   Hook - Maybe "Tick" ? Translate questions...
